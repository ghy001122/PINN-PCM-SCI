...
REMOTE = '/root/autodl-tmp/lf11-remaining-20260913'
...
def main():
    ...
    while True:
        ...
        if status != 'RUNNING':
            ...
            break
        time.sleep(30)
    relative = 'outputs/runs/20260913-lf11-remaining-pde'
    ...
    archive = ROOT/'.t/lf11-remaining-deployment/recovery.tar.gz'

...
| V2 | [paper_v2](paper_v2/README.md) | `PHK_V2_ORACLE_NO_GO_EVENT_CONTRACT_AND_CONTROL_EXECUTION_FAILURE`; no PINN method evidence. |
...
| V2.2R | [paper_v22r](paper_v22r/README.md) | Active Method-MVP build; no method result is claimed until actual nominal and sealed-case evaluation is recorded. |

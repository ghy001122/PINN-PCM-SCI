...
parser.add_argument('--document',choices=('manuscript','supplement'))
...
for name,blocks in manifest['documents'].items():
    ...
    r=fp.add_run('Core revision 26 September 2026  |  ');r.font.size=Pt(8)
    ...
    doc.core_properties.subject='Unified synthetic PINN manuscript with complete controls and mixed-measure coverage comparison'
...
summary_path=HERE/'build/docx-build-summary.json'

...
| Case | Device | Source figure | Full peaks 1/0.5 ns | Tail peaks 1/0.5 ns | Tail description | I RMS difference (mA) | I relative RMS (%) | Maximum paired peak-time difference (ns) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| single_9V | A | Fig.2A | 0 / 0 | 0 / 0 | NO_DETECTED_PEAKS_INSULATING_BRANCH | 5.61014e-06 | 0.00323229 | N/A |
| single_12p5V | A | Fig.2B | 7 / 7 | 4 / 4 | DETECTED_SPIKING | 0.0397208 | 3.50558 | 4.5 |
| single_15p8V | A | Fig.2C | 3 / 3 | 0 / 0 | NO_DETECTED_PEAKS_METALLIC_BRANCH | 0.00798651 | 0.680764 | 2.5 |
| pair_excitation | A | Fig.S11D | 5 / 5 | 3 / 3 | DETECTED_SPIKING | 0.0347522 | 3.87912 | 7 |
| pair_excitation | B | Fig.S11D | 5 / 5 | 3 / 3 | DETECTED_SPIKING | 0.0125921 | 1.62607 | 2 |
| pair_inhibition | A | Fig.S13D | 7 / 7 | 4 / 4 | DETECTED_SPIKING | 0.0223829 | 2.33628 | 3 |
| pair_inhibition | B | Fig.S13D | 2 / 2 | 0 / 0 | NO_DETECTED_PEAKS_METALLIC_BRANCH | 0.0099969 | 0.960371 | 2.5 |
...
工程检查通过：常电导 RC、零输入放电、作者反转处理和双节点热交换抵消。最大 KCL 差为 8.674e-19 A。显式 Euler 的电容离散能量项 ½C(Δv)² 单列后，最大每步能量闭合差 3.838e-24 J；这验证离散记账，不认证连续误差。运行成本及每步长温度范围详见原始报告。
...
| Record | Devices | Source voltage (V) | Channels | Samples | Use |
| --- | --- | --- | --- | --- | --- |
| Ben012_1_325K_1A2_12k_11V_many spikes_3.418us_000_ALL.csv | 1A2 | [11.0] | CH3,CH4 | 125000 | development/source qualification |
| Ben012_1_325K_1A2_12k_13V_many spikes_2.324us_000_ALL.csv | 1A2 | [13.0] | CH3,CH4 | 125000 | development/source qualification |
| Ben012_1_325K_1A2_12k_15V_many spikes_1.828us_000_ALL.csv | 1A2 | [15.0] | CH3,CH4 | 125000 | development/source qualification |
| Ben012_1_325K_1A2_12k_17V_1 spike_000_ALL.csv | 1A2 | [17.0] | CH3,CH4 | 125000 | development/source qualification |
| Ben012_1_325K_1A2_12k_9V_000_ALL.csv | 1A2 | [9.0] | CH3,CH4 | 125000 | development/source qualification |
| Ben012_1_325K_1E3_12k_2.6V_1E2_12K_2.6V_sync_000_ALL.csv | 1E3,1E2 | [2.6, 2.6] | CH1,CH2,CH3,CH4 | 31250 | development/source qualification |
| Ben012_1_325K_1E3_12k_4.1V_1E2_12K_3.7V_sync_000_ALL.csv | 1E3,1E2 | [4.1, 3.7] | CH1,CH2,CH3,CH4 | 31250 | development/source qualification |
| Ben012_1_325K_1E3_12k_4.1V_1E2_12K_3.9V_sync_000_ALL.csv | 1E3,1E2 | [4.1, 3.9] | CH1,CH2,CH3,CH4 | 31250 | COMPLETE_PROTOCOL_HOLDOUT_NOT_SCORED |
| Ben012_1_325K_1E3_12k_4.1V_1E2_12K_4V_sync_000_ALL.csv | 1E3,1E2 | [4.1, 4.0] | CH1,CH2,CH3,CH4 | 31250 | development/source qualification |
| Ben012_1_325K_1E3_12k_4V_1E2_12K_2.6V_sync_000_ALL.csv | 1E3,1E2 | [4.0, 2.6] | CH1,CH2,CH3,CH4 | 31250 | development/source qualification |
| Ben012_1_325K_1E3_12k_5V_1E2_12K_2.6V_sync_000_ALL.csv | 1E3,1E2 | [5.0, 2.6] | CH1,CH2,CH3,CH4 | 31250 | development/source qualification |
...
![single_9V: two fixed Euler steps on the same time axis.](figures/vo2-single_9V.png)

![single_12p5V: two fixed Euler steps on the same time axis.](figures/vo2-single_12p5V.png)

![single_15p8V: two fixed Euler steps on the same time axis.](figures/vo2-single_15p8V.png)

![pair_excitation: two fixed Euler steps on the same time axis.](figures/vo2-pair_excitation.png)

![pair_inhibition: two fixed Euler steps on the same time axis.](figures/vo2-pair_inhibition.png)

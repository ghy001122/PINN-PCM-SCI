...
from pinn_pcm_sci.phk_v23_lf3_evaluation import (
    LF2_M0_ROLE, LF3_P0_ROLE, LF3_T0_ROLE, adjudicate, evaluate_lf3_campaign,
)
...
class LF3AdjudicationTests(unittest.TestCase):
    ...
    def decide(self, **overrides):
        args = {"contract": self.contract, "run_status": "LF3_REFERENCE_BLIND_GPU_TRAJECTORY_COMPLETE", "evaluations": self.evaluations, "potential_guards": self.guards, "comparisons": self.comparisons, "physics": {"final_to_M0": {"passed": True}}, "t0_gate": {"passed": True, "temporal_only_failure": False}, "p0_gate": {"passed": True}}
    ...
    def test_no_pareto_and_direct_gap_are_distinct(self):
        physics = {"final_to_M0": {"passed": False}}

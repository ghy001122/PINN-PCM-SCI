...
- [0055：激活 PHK-V2.3 C0 reference/discrete/strong-form compatibility audit](0055-activate-phk-v23-c0-reference-discrete-strongform-compatibility-audit.md) — 一次本地 CPU/FP64 nominal development diagnostic；不训练、不使用 GPU、不读取 stress，完成后不自动授权下一路线。
